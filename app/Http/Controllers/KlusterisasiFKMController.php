...
class KlusterisasiFKMController extends Controller
{
    /**
    ...
    public function index( Request $res )
    {
        ...
        // echo 
        return view('klasterisasifkm/perhitunganfkm', compact('dt_kelas', 'res', 'dt_mahasiswa', 'dt_lessons'));
    }


    public function hasil() {

        $perhitunganfkm = DB::table("klusterisasi")->get();
        return view('klasterisasifkm/hasilperhitunganfkm', compact('perhitunganfkm'));
    }
    ...
    public function detail( $id ) {
        ...
        if ( $info ) {
            ...
            $decode_perhitunganfkm = json_decode($info->dt_perhitunganfkm);
            ...
            $detail = array(
                ...
                'kelas'     => $kelas,
                'pilihan'       => $pilihan,
                'perhitunganfkm'   => $decode_perhitunganfkm
            );
        }


        return view('klasterisasifkm/prosesperhitunganfkm', compact('detail'));
