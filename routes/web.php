...
use App\Http\Controllers\HistoryFKMController;
use App\Http\Controllers\HomeController;
use App\Http\Controllers\KlusterisasiController;
use App\Http\Controllers\KlusterisasiFKMController;
use App\Http\Controllers\ProfilController;
use App\Http\Controllers\Kmeans;
use App\Http\Controllers\FKmeans;
...
//fuzzy k-means
Route::resource('perhitunganfkm', KlusterisasiFKMController::class);
Route::get('/hasil-fkmeans', [KlusterisasiFKMController::class,'hasil']);
Route::get('/hasil-fkmeans/detail/{id}', [KlusterisasiFKMController::class, 'detail']);

//Laporan
Route::resource('history', HistoryController::class);
Route::resource('history', HistoryFKMController::class);
...
Route::get("/hitungfkm", [FKmeans::class, 'index']);
Route::post('/fkmeans/manual', [FKmeans::class, 'hitung_manual'])->name('kynan');
Route::get('/fkmeans/random', [FKmeans::class, 'hitung_random']);

Route::get('/scatter-plot', [ScatterPlotController::class, 'index'])->name('scatter.plot');

Route::get('/dataset', [Kmeans::class,'dataset']);

Route::get('/dataset', [FKmeans::class,'dataset']);
